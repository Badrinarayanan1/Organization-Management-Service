...
![High-Level Architecture Diagram](images/image-5.png)

## Working
![Create Organization API](images/image.png)
*Figure 1: Creating a new organization via the API.*

![Get Organization API](images/image-1.png)
*Figure 2: Retrieving details of an existing organization.*

![Update Organization API](images/image-2.png)
*Figure 3: Updating organization information and credentials.*

![Delete Organization API](images/image-3.png)
*Figure 4: Deleting an organization and its associated data.*

![Admin Login API](images/image-4.png)
